...
export const FEATURES: FeatureMeta[] = [
  ...
  },
  {
    ...
    name: "太空侵略者 · 终极版",
    category: "game",
    summary: "10 关 3 BOSS · 8 种外星单位 · 5 技能升级 · 15 成就",
    description:
      "终极进化版太空侵略者：控制战机迎击 10 关外星入侵，每 3 关一场 BOSS 战（外星护卫者、腐蚀者、元首母舰），第 10 关对决元首本体。共 8 种独特外星单位、3 主动+2 被动技能升级树、3 独立存档槽、15 成就、S/A/B/C 评分奖励技能点，支持 1080p 自适应画质（低/中/高三档）和键盘/鼠标/触屏三种无缝操作方式。",
    howTo: [
      "← → / A D 移动，空格射击；Q 大招 · E 护盾 · Shift 加速",
      "鼠标：位置控制左右，左键射击，滚轮释放技能；移动端：左摇杆 + 右下 4 按钮（44×44）",
      "过 3/6/9 关触发 BOSS 战，10 关通关元首本体即可解放地球",
      "评分 S/A/B/C 综合奖励技能点，可在技能配置界面升级 5 种技能",
    ],
    tips: [
      "优先清掉 7 号冲锋兵、6 号激光兵（威胁最大），8 号治疗兵会奶同伴建议优先点杀",
      "BOSS 战命中弱点区（发光处）伤害 ×1.5，S1 大招对 BOSS 也能造成 50%+ 伤害",
      "血量 < 35% 会自动触发动态难度保护，敌方攻击/生命自动 -20%，别放弃希望！",
    ],
    actions: { enter: true, play: true, try: false },
